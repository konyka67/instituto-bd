                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span style="color:#000; font-size: 30px">Instituto</span> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                                    ...
                                    <td align="center" valign="middle">
                                        <table>
                                            <tr>
                                                ...
                                                <h1 style="margin: 0; font-family: 'Montserrat', sans-serif; font-size: 30px; line-height: 36px; color: #ffffff; font-weight: bold;">Bienvenido {{$usuario->nombre}} </h1>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0" class="center-on-narrow" style="text-align: center;">
                                                            <tr>
                                                                <td style="border-radius: 50px; background: #26a4d3; text-align: center;" class="button-td">
                                                                    <form action="http://localhost:8000/redireccionar" method="POST" class="form-inline align-items-center justify-content-center">
                                                                        <input type="hidden" name="email" id="instituto-email" value="{{$usuario->email}}" />
                                                                        <input type="hidden" name="id" id="instituto-id" value="{{$usuario->id}}"/>
                                                                        <input type="hidden" name="password" id="instituto-password" value="{{$password}}"/>


                                                                          <button style="cursor:pointer; background: #26a4d3; border: 15px solid #26a4d3; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 1.1; text-align: center; text-decoration: none; display: block; border-radius: 50px; font-weight: bold;"  type="submit" class="btn btn-success mb-2">ACCESS ACCOUNT</button>
                                                                        </form>
