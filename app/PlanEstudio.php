...
class PlanEstudio extends Model
{
    ...
    protected $primaryKey = ['id_programa', 'id_materia', 'id_plan'];
    protected $fillable = ['id_programa', 'id_materia', 'id_plan', 'periodo', 'fecha_inicial', 'fecha_hasta'];
/**
     * The attributes of the model.
     *
     * @var array
     */
    protected $guarded  = ['id_programa', 'id_materia', 'id_plan'];
    ...
    protected function setKeysForSaveQuery(Builder $query)
    {
        $query
            ...
            ->where('id_plan', '=', $this->getAttribute('id_plan'));
